					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<input type="file" name="photo">(Chỉ sử dụng jpg,png)
							</div>
						</div>
						<div class="form-group">
